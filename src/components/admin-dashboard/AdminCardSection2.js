      ...
      <MDBCol xl="3" md="6" className="mb-3">
        <MDBCard color="primary-color" className="classic-admin-card">
          <MDBCardBody>
            ...
            <p className="white-text">Weekly Sales</p>
            <h4>
              <strong>$2000</strong>
            </h4>
          </MDBCardBody>
      ...
      <MDBCol xl="3" md="6" className="mb-3">
        <MDBCard color="warning-color" className="classic-admin-card">
          <MDBCardBody>
            ...
            <p className="white-text">New Pharmacy Users</p>
            <h4>
              <strong>200</strong>
            </h4>
          </MDBCardBody>
      ...
      <MDBCol xl="3" md="6" className="mb-3">
        <MDBCard color="primary-color" className="classic-admin-card">
          <MDBCardBody>
            ...
            <p className="white-text">Website traffic</p>
            <h4>
              <strong>20000</strong>
            </h4>
          </MDBCardBody>
      ...
      <MDBCol xl="3" md="6" className="mb-3">
        <MDBCard color="red accent-2" className="classic-admin-card">
          <MDBCardBody>
            ...
            <p className="white-text">Drug Usage</p>
            <h4>
              <strong>2000</strong>
            </h4>
          </MDBCardBody>
